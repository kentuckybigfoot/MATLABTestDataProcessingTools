...
%   Detailed explanation goes here
    ...
    pattern = {'allStbl', 'expOnly', 'diag', 'consolidation', 'moment', 'rotation', 'momRot', ... 
        'EnergyDissipated', 'forces'};
    ...
    ProcessSuperSetReqs = { ...
        {'WPAngles','WPProperties','WPCoords','BeamRotation','CenterOfRotation','Forces','Moments','EQM','EnergyDissipated'}, ...
        ...
        {'WPAngles','WPProperties','WPCoords','BeamRotation','CenterOfRotation','Moments','EnergyDissipated'}, ...
        {'forces'} ...
        };
