...
%3 preallocate
    ...
    if action == 1 %Update
        importManifest = struct('runNumber', varargin{1}.run, ...
                                ...
                                'blockRate', varargin{1}.blockrate, ...
    ...
    elseif action == 3 %Preallocate
        ...
        importManifest = struct('runNumber', dummyCell, 'RAWFilename', dummyCell, 'dataRange', dummyCell, ...
                                ...
                                'blockRate', dummyCell, 'numberOfChannels', dummyCell, 'channelNames', dummyCell, ...
                                'channelUnits', dummyCell, 'channelSensitivities', dummyCell, 'channelOffsets', dummyCell, ...
                                'channelGains', dummyCell, 'channelVoltageSlope', dummyCell, 'channelVoltageOffset', dummyCell, ...
