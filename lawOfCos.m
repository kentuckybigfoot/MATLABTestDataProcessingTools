...
alpha(:,1) = acos((dist(:,1).^2 - dist(:,2).^2 - dist(:,3).^2)./(-2*dist(:,2).*dist(:,3)));
beta(:,1)  = acos((dist(:,2).^2 - dist(:,1).^2 - dist(:,3).^2)./(-2*dist(:,1).*dist(:,3)));
gamma(:,1) = acos((dist(:,3).^2 - dist(:,1).^2 - dist(:,2).^2)./(-2*dist(:,1).*dist(:,2)));
